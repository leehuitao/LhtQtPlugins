...
void QWordDemo::on_exportPushBtn_clicked()
{
    ...
    connect(pwatcher, SIGNAL(finished()),this, SLOT(on_finished()));
    auto ret = QtConcurrent::run([=]{
        ...
        word.insertMoveDown();
        word.moveForEnd();
        word.insertPic("C:/KaweiImages/newImage/2024-04-01-20-36-03-979-0.jpg");
        word.setVisible(true);
        word.saveAs();
    });
    pwatcher->setFuture(ret);
}

void QWordDemo::on_finished()
{
    qDebug()<<"Widget QFuture f2 on_finished";
}

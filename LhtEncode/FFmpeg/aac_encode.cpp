...
AacEncode::AacEncode(LhtCodeType codeType,QObject *parent)
    : QObject(parent),m_codeType(codeType)
{

}

void AacEncode::initEncoder()
{
...
QByteArray AacEncode::encode(char *data, int len)
{
...
QByteArray AacEncode::decode(char *data, int len)
{
    // 解码数据
...
QByteArray AacEncode::encodeAudioFrame()
{
